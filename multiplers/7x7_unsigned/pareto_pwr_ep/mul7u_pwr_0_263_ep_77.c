...
uint64_t mul7u_pwr_0_263_ep_77(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  y |=  (sig_56 & 0x01) << 0; // default output
  y |=  (sig_202 & 0x01) << 1; // default output
  y |=  (sig_19 & 0x01) << 2; // default output
  y |=  (sig_55 & 0x01) << 3; // default output
...
// internal reference: cgp-nn-iccad16.07.cgpnn_mul7_e00_1_00018_csamrca
