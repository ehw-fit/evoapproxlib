...
uint64_t mul7u_pwr_0_238_ep_85(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_88 = wa[0] & wb[4];
  int sig_89 = ~(wb[1] | wb[2]);
  int sig_90 = wb[2] & wb[3];
  int sig_92 = sig_89 & wb[1];
  int sig_93 = sig_90 & wa[1];
  ...
  y |=  (sig_245 & 0x01) << 0; // default output
  y |=  (sig_130 & 0x01) << 1; // default output
  y |=  (sig_122 & 0x01) << 2; // default output
  y |=  (sig_42 & 0x01) << 3; // default output
  ...
  y |=  (sig_260 & 0x01) << 11; // default output
