/***
    ...
    uint64_t mul7u_pwr_0_130_ep_97(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_142 = sig_112 & wa[4];
  int sig_143 = wb[4] & sig_108;
  ...
  y |=  (sig_184 & 0x01) << 0; // default output
  y |=  (sig_108 & 0x01) << 1; // default output
  y |=  (sig_217 & 0x01) << 2; // default output
  y |=  (sig_217 & 0x01) << 3; // default output
  y |=  (sig_208 & 0x01) << 4; // default output
  y |=  (sig_211 & 0x01) << 5; // default output
  y |=  (sig_113 & 0x01) << 6; // default output
