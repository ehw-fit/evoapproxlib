...
uint64_t mul7u_pwr_0_254_ep_79(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_49 = wb[3] & wa[0];
  int sig_52 = wa[2] & wb[1];
  int sig_53 = wb[2] & wa[1];
  int sig_54 = sig_52 & wa[1];
  int sig_56 = sig_53 | sig_54;
  int sig_57 = sig_34 ^ sig_42;
  int sig_58 = sig_34 & sig_42;
  int sig_59 = wb[1] & sig_33;
  ...
  int sig_267 = sig_248 & wa[6];
  int sig_268 = sig_257 & sig_241;
  int sig_269 = sig_267 | sig_268;
  y |=  (sig_111 & 0x01) << 0; // default output
