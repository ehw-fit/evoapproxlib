...
uint64_t mul7u_pwr_0_208_ep_91(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_45 = sig_19 ^ sig_25;
  int sig_46 = wa[5] & wa[4];
  int sig_48 = sig_45;
  int sig_49 = sig_46 & wb[1];
  int sig_50 = sig_20 ^ sig_26;
  int sig_51 = sig_20 & sig_26;
  int sig_52 = wb[0] & sig_49;
  int sig_53 = sig_50 | sig_49;
  int sig_54 = sig_51 | sig_52;
  int sig_55 = sig_54 ^ sig_27;
  int sig_56 = sig_54 & wa[6];
  int sig_61 = wa[4] & wb[2];
  int sig_62 = wa[5] & wb[2];
  int sig_63 = wa[6] & wb[2];
  int sig_76 = sig_48;
  int sig_79 = sig_76;
  int sig_80 = wb[2] & wa[3];
  ...
  int sig_110 = sig_79 | sig_98;
  int sig_111 = sig_79 & wa[2];
  int sig_113 = sig_110;
  int sig_114 = sig_111 & wb[3];
  ...
  int sig_136 = wa[1] & wb[4];
  int sig_137 = wa[2] & wb[4];
  int sig_138 = wa[3] & wb[4];
  int sig_139 = wa[4] & wb[4];
  int sig_140 = wa[5] & wb[4];
  int sig_141 = wa[6] & wb[4];
  int sig_144 = sig_113 | sig_136;
  int sig_145 = sig_113 & wa[1];
  int sig_147 = sig_144;
  int sig_148 = sig_145 & wb[4];
  int sig_149 = sig_118 ^ sig_137;
  int sig_150 = sig_118 & sig_137;
  int sig_151 = sig_149 & sig_148;
  int sig_152 = sig_149 ^ sig_148;
  int sig_153 = sig_150 ^ sig_151;
  ...
  int sig_181 = sig_147 | sig_174;
  int sig_182 = sig_147 & sig_174;
  int sig_183 = sig_152 ^ sig_175;
  int sig_184 = sig_152 & sig_175;
  int sig_185 = sig_183 & sig_182;
  ...
  y |=  (sig_155 & 0x01) << 1; // default output
  y |=  (sig_234 & 0x01) << 2; // default output
  y |=  (sig_134 & 0x01) << 3; // default output
  y |=  (sig_213 & 0x01) << 4; // default output
  y |=  (sig_181 & 0x01) << 5; // default output
