...
uint64_t mul7u_pwr_0_204_ep_92(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_93 = wa[3] & wb[0];
  int sig_97 = wb[4] & wa[1];
  ...
  int sig_125 = wa[0] & wb[5];
  int sig_126 = sig_97 ^ sig_115;
  int sig_127 = wa[1] & wa[0];
  int sig_129 = sig_126 | sig_93;
  int sig_130 = sig_127 & wb[4];
  ...
  y |=  (sig_239 & 0x01) << 0; // default output
  y |=  (sig_196 & 0x01) << 1; // default output
  y |=  (sig_72 & 0x01) << 2; // default output
  y |=  (sig_107 & 0x01) << 3; // default output
  y |=  (sig_117 & 0x01) << 4; // default output
