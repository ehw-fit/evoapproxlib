...
uint64_t mul7u_pwr_0_173_wce_00_9399(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_51 = wb[1] & wa[5];
  int sig_54 = sig_51 & wa[6];
  int sig_55 = sig_54 ^ sig_27;
  int sig_56 = sig_54;
  int sig_60 = wa[3] & wb[2];
  int sig_62 = wa[5] & wb[2];
  int sig_63 = wa[6] & wb[2];
  int sig_76 = wa[5] ^ sig_60;
  int sig_78 = sig_76;
  int sig_80 = wa[5] ^ sig_78;
  int sig_82 = wb[2] & wa[4];
  int sig_83 = wb[0] & sig_80;
  int sig_84 = wb[0] & wa[4];
  int sig_85 = sig_82 | sig_83;
  int sig_86 = sig_55 | sig_62;
  int sig_87 = sig_55 & wa[5];
  ...
  int sig_184 = sig_152 & wa[1];
  int sig_186 = sig_183;
  int sig_187 = sig_184 & wb[5];
  ...
  y |=  (sig_190 & 0x01) << 1; // default output
  y |=  (sig_127 & 0x01) << 2; // default output
  y |=  (sig_200 & 0x01) << 3; // default output
  y |=  (sig_155 & 0x01) << 4; // default output
  y |=  (sig_179 & 0x01) << 5; // default output
...
// internal reference: cgp-nn-iccad16.07.cgpnn_mul7_e01_0_00795_rcam
