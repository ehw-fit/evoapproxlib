...
uint64_t mul7u_pwr_0_242_wce_00_1709(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  y |=  (sig_176 & 0x01) << 0; // default output
  y |=  (sig_102 & 0x01) << 1; // default output
  y |=  (sig_237 & 0x01) << 2; // default output
