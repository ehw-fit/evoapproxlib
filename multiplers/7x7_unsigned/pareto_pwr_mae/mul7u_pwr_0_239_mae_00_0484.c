...
uint64_t mul7u_pwr_0_239_mae_00_0484(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_122 = sig_92 & wb[4];
  int sig_125 = sig_122 & wa[0];
  ...
  y |=  (sig_159 & 0x01) << 0; // default output
  y |=  (sig_167 & 0x01) << 1; // default output
  y |=  (sig_151 & 0x01) << 2; // default output
  y |=  (sig_26 & 0x01) << 3; // default output
  y |=  (sig_121 & 0x01) << 4; // default output
