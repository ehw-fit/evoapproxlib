/***
    ...
    uint64_t mul7u_pwr_0_179_mae_00_2194(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_163 = sig_134;
  int sig_164 = sig_134 & wa[1];
  int sig_166 = sig_163 ^ sig_130;
  int sig_167 = sig_164 & wb[5];
  ...
  int sig_196 = sig_166 & wb[6];
  int sig_199 = sig_196 & wa[0];
  ...
  int sig_258 = wb[4] ^ wb[4];
  int sig_259 = wa[1] & sig_258;
  int sig_260 = ~(sig_251 ^ sig_241);
  int sig_261 = sig_259 ^ sig_260;
  int sig_262 = !sig_241;
  ...
  y |=  (sig_26 & 0x01) << 0; // default output
  y |=  (sig_235 & 0x01) << 1; // default output
  y |=  (sig_183 & 0x01) << 2; // default output
  y |=  (sig_189 & 0x01) << 3; // default output
  y |=  (sig_38 & 0x01) << 4; // default output
  y |=  (sig_169 & 0x01) << 5; // default output
  ...
  y |=  (sig_261 & 0x01) << 11; // default output
