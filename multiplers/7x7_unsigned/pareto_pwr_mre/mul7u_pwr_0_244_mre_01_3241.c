...
uint64_t mul7u_pwr_0_244_mre_01_3241(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  y |=  (sig_80 & 0x01) << 3; // default output
  y |=  (sig_92 & 0x01) << 4; // default output
