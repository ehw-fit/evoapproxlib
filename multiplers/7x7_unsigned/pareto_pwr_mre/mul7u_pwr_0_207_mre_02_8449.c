...
uint64_t mul7u_pwr_0_207_mre_02_8449(uint64_t a, uint64_t b) {
  int wa[7];
  int wb[7];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_143 = wb[4] & wa[1];
  int sig_144 = sig_113 ^ sig_136;
  int sig_147 = sig_144 ^ sig_143;
  int sig_148 = wa[1] & wb[4];
  ...
  y |=  (sig_228 & 0x01) << 0; // default output
  y |=  (sig_136 & 0x01) << 1; // default output
  y |=  (sig_238 & 0x01) << 2; // default output
  y |=  (sig_113 & 0x01) << 3; // default output
  y |=  (sig_147 & 0x01) << 4; // default output
