...
uint32_t mul12u_pwr_1_053_mse_9158_2500(uint16_t A, uint16_t B)
{
  uint32_t P, P_;
  ...
  S_4_11 = (((A>>4)&1) & ((B>>11)&1));
  S_5_1 = S_4_2^(((A>>5)&1) & ((B>>1)&1));
  C_5_1 = S_4_2&(((A>>5)&1) & ((B>>1)&1));
  tmp = S_4_3^C_4_2;
  ...
  S_5_11 = (((A>>5)&1) & ((B>>11)&1));
  S_6_0 = S_5_1^(((A>>6)&1) & ((B>>0)&1));
  C_6_0 = S_5_1&(((A>>6)&1) & ((B>>0)&1));
  tmp = S_5_2^C_5_1;
...
// internal reference: truncation-bam.12.bam12_00_06
