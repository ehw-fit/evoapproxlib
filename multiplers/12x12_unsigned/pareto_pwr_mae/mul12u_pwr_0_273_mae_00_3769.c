...
uint32_t mul12u_pwr_0_273_mae_00_3769(uint16_t A, uint16_t B)
{
  ...
  S_6_8 = S_5_9^(((A>>6)&1) & ((B>>8)&1));
  C_6_8 = S_5_9&(((A>>6)&1) & ((B>>8)&1));
