...
int32_t mul16s_pwr_2_208_mre_00_0118(int16_t A, int16_t B)
{
  int32_t P, P_;
  ...
  S_5_4 = S_4_5^(((A>>5)&1) & ((B>>4)&1));
  C_5_4 = S_4_5&(((A>>5)&1) & ((B>>4)&1));
  tmp = S_4_6^C_4_5;
  ...
  S_6_3 = S_5_4^(((A>>6)&1) & ((B>>3)&1));
  C_6_3 = S_5_4&(((A>>6)&1) & ((B>>3)&1));
  tmp = S_5_5^C_5_4;
  ...
  S_8_1 = S_7_2^(((A>>8)&1) & ((B>>1)&1));
  C_8_1 = S_7_2&(((A>>8)&1) & ((B>>1)&1));
  tmp = S_7_3^C_7_2;
  ...
  S_9_0 = S_8_1^(((A>>9)&1) & ((B>>0)&1));
  C_9_0 = S_8_1&(((A>>9)&1) & ((B>>0)&1));
  tmp = S_8_2^C_8_1;
...
// internal reference: truncation-bam.16.bams16_00_09
