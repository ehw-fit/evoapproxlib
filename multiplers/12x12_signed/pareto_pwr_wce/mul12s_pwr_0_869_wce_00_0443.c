...
int32_t mul12s_pwr_0_869_wce_00_0443(int16_t A, int16_t B)
{
  int32_t P, P_;
  ...
  S_2_10 = (((A>>2)&1) & ((B>>10)&1));
  S_2_11 = 1^(((((A>>2)&1) & ((B>>11)&1)))^1);
  C_2_11 = 1&(((((A>>2)&1) & ((B>>11)&1)))^1);
  ...
  S_8_0 = S_7_1^(((A>>8)&1) & ((B>>0)&1));
  C_8_0 = S_7_1&(((A>>8)&1) & ((B>>0)&1));
  tmp = S_7_2^C_7_1;
...
// internal reference: truncation-bam.12.bams12_02_08
