    ...
    int32_t mul12s_pwr_0_549_wce_00_2686(int16_t A, int16_t B)
{
  ...
  S_11_1 = S_10_2^(((((A>>11)&1) & ((B>>1)&1)))^1);
  C_11_1 = S_10_2&(((((A>>11)&1) & ((B>>1)&1)))^1);
  tmp = S_10_3^C_10_2;
...
// internal reference: truncation-bam.12.bams12_03_12
