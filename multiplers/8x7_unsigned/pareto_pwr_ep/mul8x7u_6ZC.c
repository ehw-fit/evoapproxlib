...
uint64_t mul8x7u_6ZC(const uint64_t A,const uint64_t B)
{
   ...
   dout_30=((A >> 7)&1)&((B >> 1)&1);
   dout_31=((A >> 4)&1)&((B >> 0)&1);
   dout_43=dout_31^dout_26;
   dout_44=((A >> 4)&1)&dout_18;
   dout_45=((B >> 1)&1)&dout_18;
   ...
   dout_71=((A >> 6)&1)&((B >> 2)&1);
   dout_72=((A >> 7)&1)&((B >> 2)&1);
   dout_73=dout_25&dout_66;
   dout_75=dout_25|dout_66;
   dout_80=dout_46^dout_67;
   dout_81=dout_46&dout_67;
   dout_83=dout_80^dout_73;
   dout_84=dout_81|dout_73;
