...
uint64_t mul8x4u_42Z(const uint64_t A,const uint64_t B)
{
   ...
   dout_18=((A >> 6)&1)&((B >> 0)&1);
   dout_19=((A >> 7)&1)&((B >> 0)&1);
   dout_21=dout_15&((A >> 4)&1);
   dout_24=((A >> 4)&1)&((B >> 1)&1);
   dout_25=((A >> 5)&1)&((B >> 1)&1);
   dout_26=((A >> 6)&1)&((B >> 1)&1);
   dout_27=((A >> 7)&1)&((B >> 1)&1);
   dout_30=((A >> 3)&1)&((B >> 1)&1);
   dout_40=dout_16^dout_30;
   dout_42=((B >> 1)&1)&dout_15;
   dout_43=dout_40^dout_15;
   dout_44=dout_21|dout_42;
   ...
   dout_68=((A >> 6)&1)&((B >> 2)&1);
   dout_69=((A >> 7)&1)&((B >> 2)&1);
   dout_72=dout_14|dout_63;
   dout_77=dout_43^dout_64;
   dout_78=dout_43&dout_64;
   dout_79=dout_63&dout_14;
   dout_80=dout_77^dout_79;
