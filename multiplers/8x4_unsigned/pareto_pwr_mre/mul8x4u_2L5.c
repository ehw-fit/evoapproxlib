...
uint64_t mul8x4u_2L5(const uint64_t A,const uint64_t B)
{
   ...
   dout_40=dout_12^dout_23;
   dout_41=dout_12&dout_23;
   ...
   dout_59=dout_32|dout_57;
   dout_60=dout_59&dout_19;
   dout_61=dout_59^dout_16;
   dout_62=((A >> 0)&1)&((B >> 2)&1);
   dout_63=((A >> 1)&1)&((B >> 2)&1);
   dout_64=((A >> 2)&1)&((B >> 2)&1);
   dout_65=((A >> 3)&1)&((B >> 2)&1);
