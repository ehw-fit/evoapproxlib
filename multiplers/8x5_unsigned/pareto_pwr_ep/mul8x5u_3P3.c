...
uint64_t mul8x5u_3P3(const uint64_t A,const uint64_t B)
{
   ...
   dout_27=((A >> 6)&1)&((B >> 1)&1);
   dout_28=((A >> 7)&1)&((B >> 1)&1);
   dout_44=dout_24|dout_22;
   dout_46=dout_18^dout_25;
   dout_47=((A >> 4)&1)&dout_15;
   dout_49=dout_46^dout_17;
   ...
   dout_118=dout_44^dout_109;
   dout_119=dout_44&dout_109;
