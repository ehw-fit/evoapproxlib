...
uint64_t mul8x5u_1F9(const uint64_t A /* 8-bit unsigned operand */, const uint64_t B /* 5-bit unsigned operand */)
{
   ...
   dout_58=dout_56&dout_52;
   dout_59=dout_56^dout_52;
