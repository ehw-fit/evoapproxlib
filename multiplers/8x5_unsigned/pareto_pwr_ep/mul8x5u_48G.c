...
uint64_t mul8x5u_48G(const uint64_t A,const uint64_t B)
{
   ...
   dout_69=((A >> 6)&1)&((B >> 2)&1);
   dout_70=((A >> 7)&1)&((B >> 2)&1);
   dout_71=dout_31&dout_63;
   dout_72=dout_31^dout_63;
