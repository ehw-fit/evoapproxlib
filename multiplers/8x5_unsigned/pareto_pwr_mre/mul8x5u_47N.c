...
uint64_t mul8x5u_47N(const uint64_t A,const uint64_t B)
{
   ...
   dout_69=((A >> 6)&1)&((B >> 2)&1);
   dout_70=((A >> 7)&1)&((B >> 2)&1);
   dout_71=dout_14&dout_64;
   dout_72=dout_14|dout_63;
   dout_73=dout_39^dout_63;
   dout_74=dout_39&dout_64;
   dout_76=dout_73^dout_71;
   dout_77=dout_74|dout_71;
