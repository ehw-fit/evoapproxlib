...
uint16_t mul8_339(uint8_t a, uint8_t b)
{
  uint16_t c = 0;
  uint8_t n0 = (a >> 0) & 0x1;
  uint8_t n2 = (a >> 1) & 0x1;
  ...
  n1112 = n402 ^ n506;
  n1113 = n402 & n506;
  n1128 = (n97 ^ n520) ^ n1083;
  n1129 = (n97 & n520) | (n520 & n1083) | (n97 & n1083);
  ...
  n1542 = (n1306 ^ n1291) ^ n833;
  n1543 = (n1306 & n1291) | (n1291 & n833) | (n1306 & n833);
