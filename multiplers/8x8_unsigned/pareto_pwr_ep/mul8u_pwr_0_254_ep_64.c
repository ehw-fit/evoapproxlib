...
uint64_t mul8u_pwr_0_254_ep_64(const uint64_t B,const uint64_t A)
{
   ...
   dout_81=dout_47|dout_68;
   dout_86=dout_49|dout_69;
   dout_94=dout_70|dout_54;
