...
uint64_t mul8u_pwr_0_313_mre_00_6390(const uint64_t B,const uint64_t A)
{
   ...
   dout_52=((B >> 6)&1)&((A >> 2)&1);
   dout_53=((B >> 7)&1)&((A >> 2)&1);
   dout_57=dout_34|dout_46;
   dout_64=dout_38|dout_48;
   dout_70=dout_49&dout_28;
   dout_72=dout_40|dout_49;
   ...
   dout_226=dout_188^dout_218;
   dout_227=dout_188&dout_218;
