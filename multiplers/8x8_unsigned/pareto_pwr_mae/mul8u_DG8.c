...
uint64_t mul8u_DG8(const uint64_t B,const uint64_t A)
{
   ...
   dout_52=((B >> 6)&1)&((A >> 2)&1);
   dout_53=((B >> 7)&1)&((A >> 2)&1);
   dout_54=dout_25|dout_46;
   dout_59=dout_19|dout_47;
