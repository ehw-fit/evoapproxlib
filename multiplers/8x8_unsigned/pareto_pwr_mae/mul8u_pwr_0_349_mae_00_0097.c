    ...
    uint64_t mul8u_pwr_0_349_mae_00_0097(const uint64_t B,const uint64_t A)
{
   ...
   dout_57=dout_54|dout_47;
   dout_65=dout_38&dout_48;
   dout_67=dout_38|dout_48;
