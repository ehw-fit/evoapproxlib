...
uint64_t mul8x6u_3FS(const uint64_t A,const uint64_t B)
{
   ...
   dout_28=((A >> 6)&1)&((B >> 1)&1);
   dout_29=((A >> 7)&1)&((B >> 1)&1);
   dout_37=(((B >> 1)&1)&((A >> 2)&1))^0xFFFFFFFFFFFFFFFFU;
   dout_39=((A >> 3)&1)&((B >> 0)&1);
   dout_40=dout_37^0xFFFFFFFFFFFFFFFFU;
   dout_41=dout_17|dout_39;
   dout_44=dout_22&((B >> 0)&1);
   dout_45=dout_22^dout_41;
   dout_47=dout_19^dout_16;
   dout_48=dout_19&dout_16;
   dout_49=dout_47&dout_44;
   dout_50=dout_47^dout_44;
