...
uint64_t mul11u_pwr_0_728_wce_00_0942(uint64_t a, uint64_t b) {
  int wa[11];
  int wb[11];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  wa[10] = (a >> 10) & 0x01;
  wb[10] = (b >> 10) & 0x01;
  int sig_28 = wa[8] & wa[8];
  int sig_30 = wa[1] & wb[8];
  int sig_31 = wa[9] & wb[0];
  int sig_32 = wa[10] & wb[0];
  int sig_38 = wa[3] & wb[1];
  int sig_40 = wa[7] & wb[1];
  int sig_41 = wa[8] & wb[1];
  int sig_42 = wa[9] & wb[1];
  int sig_43 = wa[10] & wb[1];
  int sig_67 = sig_28 & sig_38;
  int sig_76 = sig_30 ^ sig_40;
  int sig_77 = sig_30;
  int sig_78 = sig_76;
  int sig_79 = wa[1] & wb[4];
  int sig_80 = sig_77 | sig_78;
  int sig_81 = sig_31 ^ sig_41;
  int sig_82 = sig_31 & sig_41;
  ...
  int sig_193 = wa[2] & wb[3];
  int sig_194 = sig_139 ^ sig_162;
  int sig_195 = wb[3] & sig_162;
  ...
  int sig_301 = wb[8] & wb[4];
  int sig_304 = sig_301 | wb[5];
  int sig_305 = wa[2] | wa[10];
  int sig_306 = wa[3] & wb[5];
  int sig_307 = sig_305 & sig_304;
  int sig_309 = sig_306 | sig_307;
  int sig_310 = sig_255 ^ sig_286;
  int sig_311 = sig_255 & sig_286;
  ...
  int sig_364 = wa[10] & sig_347;
  int sig_366 = ~(wb[0] & wb[0]);
  int sig_367 = sig_364;
  int sig_368 = sig_313 ^ sig_348;
  int sig_369 = sig_313 & sig_348;
  int sig_371 = sig_368 ^ sig_367;
  int sig_372 = sig_369;
  ...
  int sig_408 = wa[5] & wb[7];
  int sig_409 = wb[1] & wb[0];
  int sig_410 = wa[8] & wb[7];
  ...
  int sig_420 = wb[0] & sig_408;
  int sig_422 = sig_366 & sig_409;
  int sig_423 = wb[0] & sig_420;
  int sig_425 = sig_422 | sig_423;
  int sig_426 = sig_371 ^ sig_410;
  int sig_427 = sig_371 & sig_410;
  int sig_428 = sig_426 & sig_425;
  ...
  int sig_482 = wa[0] & wb[7];
  int sig_484 = sig_429 | sig_472;
  int sig_485 = wa[4] & sig_472;
  int sig_486 = sig_484;
  int sig_487 = sig_484;
  int sig_488 = sig_485 ^ sig_486;
  ...
  int sig_545 = sig_487 ^ sig_534;
  int sig_546 = wb[8] & sig_534;
  ...
  y |=  (sig_569 & 0x01) << 0; // default output
  y |=  (sig_610 & 0x01) << 1; // default output
  y |=  (sig_67 & 0x01) << 2; // default output
  y |=  (sig_374 & 0x01) << 3; // default output
  y |=  (sig_97 & 0x01) << 4; // default output
  y |=  (sig_207 & 0x01) << 5; // default output
  y |=  (sig_379 & 0x01) << 6; // default output
  y |=  (sig_474 & 0x01) << 7; // default output
