/***
    ...
    uint64_t mul11u_pwr_0_483_mae_00_0867(uint64_t a, uint64_t b) {
  int wa[11];
  int wb[11];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  wa[10] = (a >> 10) & 0x01;
  wb[10] = (b >> 10) & 0x01;
  int sig_22 = wa[9] & wb[0];
  int sig_23 = wa[1] & wb[0];
  int sig_27 = wa[8] & wb[0];
  int sig_28 = wa[6] & wb[0];
  int sig_33 = wa[1] & wb[10];
  int sig_36 = wb[6] & wa[8];
  int sig_37 = wa[3] & wb[7];
  int sig_43 = wa[10] & wb[1];
  int sig_44 = sig_23 ^ sig_33;
  int sig_57 = wa[4] & sig_36;
  int sig_60 = sig_57;
  int sig_61 = sig_27 ^ sig_37;
  int sig_62 = wa[8] & wb[4];
  int sig_63 = sig_61 & wb[7];
  int sig_64 = sig_61 ^ sig_60;
  int sig_65 = sig_62 | sig_63;
  int sig_66 = sig_28;
  int sig_69 = sig_66 | sig_65;
  int sig_92 = wa[8] & sig_43;
  int sig_97 = wa[4] & wb[9];
  int sig_102 = wa[9] & wb[2];
  int sig_103 = wa[10] & wb[2];
  int sig_121 = sig_69 ^ sig_97;
  int sig_147 = wa[8] & sig_102;
  int sig_150 = sig_147;
  ...
  int sig_219 = wa[0] & wb[4];
  int sig_227 = wa[8] & wb[4];
  int sig_228 = wa[9] & wb[4];
  int sig_229 = wa[10] & wb[4];
  int sig_259 = wa[3] & wb[4];
  int sig_260 = wa[2] & wb[8];
  int sig_261 = wa[4] & sig_259;
  int sig_263 = wb[3] & wa[2];
  int sig_264 = wa[1] & sig_261;
  ...
  int sig_288 = wa[8] & wb[5];
  int sig_289 = wa[7] & wb[5];
  int sig_290 = wa[8] & wb[5];
  int sig_291 = wa[9] & wb[5];
  int sig_292 = wa[10] & wb[5];
  int sig_314 = wb[7] | wa[9];
  int sig_316 = sig_260 & sig_287;
  int sig_317 = wa[5] & sig_314;
  int sig_318 = wa[6] ^ sig_314;
  int sig_319 = sig_316 & sig_317;
  int sig_320 = wa[5] ^ sig_288;
  int sig_321 = wa[0] & wb[9];
  int sig_322 = wb[6] & sig_319;
  ...
  int sig_490 = sig_434 & wa[1];
  int sig_493 = sig_490;
  int sig_494 = sig_439;
  int sig_495 = wa[7] & wb[3];
  int sig_496 = wb[3] & sig_493;
  ...
  y |=  (sig_514 & 0x01) << 2; // default output
  y |=  (sig_385 & 0x01) << 3; // default output
  y |=  (sig_64 & 0x01) << 4; // default output
  y |=  (sig_553 & 0x01) << 5; // default output
  y |=  (sig_219 & 0x01) << 6; // default output
  y |=  (sig_341 & 0x01) << 7; // default output
  y |=  (sig_121 & 0x01) << 8; // default output
  y |=  (sig_390 & 0x01) << 9; // default output
  y |=  (sig_228 & 0x01) << 10; // default output
  y |=  (sig_478 & 0x01) << 11; // default output
