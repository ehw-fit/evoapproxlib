...
uint64_t mul11u_pwr_0_690_mae_00_0186(uint64_t a, uint64_t b) {
  int wa[11];
  int wb[11];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  wa[10] = (a >> 10) & 0x01;
  wb[10] = (b >> 10) & 0x01;
  int sig_30 = ~(wa[8] & wb[8]);
  int sig_31 = wa[9] & wb[0];
  int sig_32 = wa[10] & wb[0];
  int sig_41 = wb[0] & wb[1];
  int sig_42 = wa[6] & wb[1];
  int sig_43 = wa[10] & wb[1];
  int sig_58 = sig_30;
  int sig_59 = sig_30 & wa[8];
  int sig_60 = sig_31;
  ...
  int sig_153 = wb[7] | wa[1];
  int sig_155 = ~(wa[9] | sig_153);
  ...
  int sig_205 = wb[3] & wa[10];
  int sig_214 = wa[9] & sig_155;
  int sig_215 = ~(wb[4] | wb[1]);
  int sig_216 = wb[8] | sig_214;
  int sig_217 = wa[1];
  int sig_218 = wb[6] & wa[5];
  int sig_219 = sig_217 & wb[9];
  int sig_220 = ~(wb[3] & wb[0]);
  int sig_221 = sig_218;
  ...
  int sig_261 = sig_258;
  int sig_268 = sig_215 & wb[1];
  int sig_269 = sig_215 & wb[3];
  int sig_270 = sig_268 & wa[4];
  int sig_272 = sig_269 | sig_270;
  int sig_273 = wb[3] ^ wa[7];
  int sig_274 = !sig_220;
  int sig_276 = sig_273 ^ sig_216;
  int sig_277 = sig_274 & wa[7];
  ...
  int sig_329 = ~(wb[4] & wb[8]);
  int sig_330 = sig_276 & sig_310;
  int sig_331 = wb[1] & sig_272;
  int sig_332 = sig_329;
  int sig_333 = sig_330 | sig_331;
  int sig_334 = wa[2] & sig_311;
  ...
  int sig_442 = wa[9] | wb[5];
  int sig_443 = ~(wa[2] | wa[4]);
  ...
  y |=  (sig_373 & 0x01) << 0; // default output
  y |=  (sig_241 & 0x01) << 1; // default output
  y |=  (sig_619 & 0x01) << 2; // default output
  y |=  (sig_219 & 0x01) << 3; // default output
  y |=  (sig_613 & 0x01) << 4; // default output
  y |=  (sig_261 & 0x01) << 5; // default output
  y |=  (sig_417 & 0x01) << 6; // default output
  y |=  (sig_551 & 0x01) << 7; // default output
  y |=  (sig_419 & 0x01) << 8; // default output
