...
uint64_t mul11u_pwr_0_500_mre_03_2590(uint64_t a, uint64_t b) {
  int wa[11];
  int wb[11];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  wa[10] = (a >> 10) & 0x01;
  wb[10] = (b >> 10) & 0x01;
  int sig_24 = wa[4] & wb[2];
  int sig_32 = wb[8] & wb[5];
  int sig_34 = wa[1] & wb[1];
  int sig_42 = wa[9] & wb[1];
  int sig_45 = wb[7] & wa[7];
  int sig_46 = sig_24 ^ sig_34;
  int sig_61 = wa[8] & wb[10];
  int sig_62 = sig_32 ^ sig_42;
  int sig_63 = wa[7] & sig_42;
  int sig_64 = wa[5] & wb[2];
  int sig_73 = wa[9] & wb[10];
  int sig_74 = wa[10] & wb[2];
  int sig_75 = sig_46 | sig_64;
  int sig_78 = sig_75 ^ sig_45;
  int sig_114 = wb[8] | wa[1];
  int sig_115 = sig_62 ^ wb[0];
  int sig_117 = sig_115 & sig_61;
  int sig_119 = wb[6] & sig_117;
  int sig_120 = wa[0] ^ sig_73;
  int sig_121 = wb[3] & sig_73;
  int sig_122 = sig_120 & sig_63;
  int sig_123 = sig_120 ^ sig_63;
  int sig_124 = sig_121 | sig_122;
  int sig_133 = wa[8] & wb[10];
  int sig_134 = wa[9] & wb[3];
  int sig_135 = wa[10] & wb[3];
  int sig_173 = wb[5] & sig_114;
  int sig_174 = wa[4] | sig_114;
  int sig_175 = wb[0] | sig_173;
  int sig_176 = sig_123 ^ sig_133;
  int sig_177 = sig_123 & sig_133;
  int sig_178 = wb[1] & sig_119;
  ...
  int sig_231 = sig_228;
  int sig_233 = sig_179 & wb[5];
  int sig_235 = wb[4] ^ sig_175;
  int sig_236 = sig_233;
  ...
  int sig_452 = wa[4] & wb[2];
  int sig_453 = wa[5] & sig_394;
  ...
  int sig_569 = wa[5] & sig_553;
  int sig_570 = wb[1] & sig_511;
  ...
  y |=  (sig_638 & 0x01) << 0; // default output
  y |=  (sig_297 & 0x01) << 1; // default output
  y |=  (sig_78 & 0x01) << 2; // default output
  y |=  (sig_289 & 0x01) << 3; // default output
  y |=  (sig_358 & 0x01) << 4; // default output
  y |=  (sig_640 & 0x01) << 5; // default output
  y |=  (sig_535 & 0x01) << 6; // default output
  y |=  (sig_476 & 0x01) << 7; // default output
  y |=  (sig_63 & 0x01) << 8; // default output
  y |=  (sig_354 & 0x01) << 9; // default output
  y |=  (sig_549 & 0x01) << 10; // default output
  y |=  (sig_501 & 0x01) << 11; // default output
