...
uint64_t mul11u_pwr_0_784_mre_00_6399(uint64_t a, uint64_t b) {
  int wa[11];
  int wb[11];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_40 = wb[2] & wb[1];
  int sig_41 = wa[5] & wb[1];
  int sig_42 = wa[9] & wb[1];
  int sig_43 = wa[10] & wb[1];
  int sig_57 = wb[3] & wa[8];
  ...
  int sig_105 = sig_58;
  int sig_106 = wb[8] & sig_70;
  int sig_107 = wb[1] & sig_57;
  int sig_108 = sig_105 & wa[0];
  ...
  int sig_162 = wb[4] & sig_130;
  int sig_164 = sig_161;
  int sig_165 = sig_162;
  int sig_166 = sig_113 | sig_131;
  int sig_167 = wa[6] & sig_131;
  ...
  int sig_210 = wb[6] ^ wb[4];
  int sig_214 = wb[4] & wa[1];
  int sig_216 = wa[10] | sig_214;
  int sig_217 = sig_164 ^ sig_190;
  int sig_218 = sig_164 & wb[10];
  int sig_219 = wa[4] & wb[1];
  int sig_220 = sig_217 ^ wb[8];
  int sig_221 = sig_218 | sig_219;
  int sig_222 = sig_169 ^ sig_191;
  int sig_223 = wa[8] & sig_191;
  int sig_224 = wa[8] & sig_165;
  ...
  int sig_250 = wa[3] & wb[3];
  int sig_251 = wa[3] & wb[5];
  ...
  int sig_308 = wa[0] & wb[7];
  int sig_310 = wa[2] & wb[9];
  ...
  int sig_320 = wb[4] & sig_308;
  int sig_321 = wb[5] & wa[4];
  int sig_323 = sig_320 | sig_321;
  int sig_327 = wa[0] ^ sig_267;
  int sig_330 = sig_276 & sig_310;
  int sig_331 = wb[8] & sig_272;
  int sig_333 = sig_330 | sig_331;
  int sig_334 = sig_281 ^ sig_311;
  int sig_335 = wb[10] & sig_311;
  int sig_336 = sig_334 & wa[10];
  ...
  int sig_381 = wa[6] & sig_369;
  int sig_382 = wb[5] & sig_323;
  int sig_383 = sig_380 ^ sig_323;
  int sig_384 = sig_381 ^ sig_382;
  int sig_386 = wa[6] & wb[1];
  int sig_387 = wa[10] & wb[3];
  ...
  int sig_442 = wb[5] & wa[4];
  int sig_443 = wb[2] & sig_384;
  ...
  y |=  (sig_511 & 0x01) << 0; // default output
  y |=  (sig_698 & 0x01) << 1; // default output
  y |=  (sig_391 & 0x01) << 2; // default output
  y |=  (sig_226 & 0x01) << 3; // default output
  y |=  (sig_301 & 0x01) << 4; // default output
  y |=  (sig_665 & 0x01) << 5; // default output
  y |=  (sig_653 & 0x01) << 6; // default output
  y |=  (sig_383 & 0x01) << 7; // default output
  y |=  (sig_609 & 0x01) << 8; // default output
...
// internal reference: cgp-nn-iccad16.11.cgpnn_mul11_e00_1_00108_csamcsa
