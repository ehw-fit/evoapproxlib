/***
    ...
    uint64_t mul11u_pwr_0_637_mre_01_3375(uint64_t a, uint64_t b) {
  int wa[11];
  int wb[11];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_33 = wa[9] & wb[1];
  int sig_42 = wa[3] & wb[1];
  int sig_43 = wa[10] & wb[1];
  int sig_44 = sig_23 | sig_33;
  int sig_59 = wa[5] & wb[2];
  int sig_60 = !wa[6];
  int sig_61 = wa[0] & wb[8];
  ...
  int sig_165 = wa[7] | wb[7];
  int sig_167 = wa[4] & wb[5];
  int sig_170 = sig_167;
  ...
  int sig_190 = wa[7] & wb[4];
  int sig_192 = wa[9] & wb[4];
  int sig_193 = wa[7] & wb[4];
  int sig_194 = wa[8] & wb[4];
  int sig_195 = wa[9] & wb[4];
  int sig_196 = wa[10] & wb[4];
  int sig_218 = wa[8] & sig_190;
  int sig_219 = wa[6] & wb[7];
  int sig_221 = sig_218 | sig_219;
  int sig_224 = wa[0] & sig_165;
  int sig_226 = wb[3] & sig_224;
  ...
  int sig_279 = wa[2] & wb[6];
  int sig_280 = wb[2] & sig_221;
  int sig_281 = wa[6] | sig_221;
  ...
  int sig_334 = sig_281;
  int sig_335 = sig_281 & wb[9];
  int sig_336 = sig_334 & wb[6];
  int sig_337 = wa[7] & wa[3];
  ...
  int sig_346 = wa[6] & sig_287;
  int sig_347 = wb[6] & sig_287;
  ...
  int sig_385 = wa[4] ^ wa[5];
  int sig_388 = sig_385;
  int sig_389 = wb[7] | wb[1];
  ...
  int sig_503 = wb[0] & sig_491;
  int sig_504 = wb[6] & sig_445;
  ...
  int sig_656 = wb[10] & sig_612;
  int sig_657 = sig_655 & sig_654;
  int sig_658 = sig_655 ^ sig_654;
  int sig_659 = sig_656 | sig_657;
  y |=  (sig_283 & 0x01) << 0; // default output
  y |=  (sig_44 & 0x01) << 1; // default output
  y |=  (sig_409 & 0x01) << 2; // default output
  y |=  (sig_304 & 0x01) << 3; // default output
  y |=  (sig_256 & 0x01) << 4; // default output
  y |=  (sig_579 & 0x01) << 5; // default output
  y |=  (sig_398 & 0x01) << 6; // default output
  y |=  (sig_406 & 0x01) << 7; // default output
  y |=  (sig_44 & 0x01) << 8; // default output
  y |=  (sig_373 & 0x01) << 9; // default output
