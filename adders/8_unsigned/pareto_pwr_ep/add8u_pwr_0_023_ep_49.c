...
uint64_t add8u_pwr_0_023_ep_49(uint64_t a, uint64_t b) {
  int wa[8];
  int wb[8];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  y |=  (sig_16 & 0x01) << 2; // default output
...
// internal reference: cgp-add-bdd.08.bdd_sift_bw_8_core_0_ep_0_50_run_00004
