...
uint64_t add8u_pwr_0_009_mae_02_0312(uint64_t a, uint64_t b) {
  int wa[8];
  int wb[8];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  y |=  (sig_33 & 0x01) << 5; // default output
...
// internal reference: cgp-add-bdd.08.bdd_sift_bw_8_core_1_mae_000011_run_00003
