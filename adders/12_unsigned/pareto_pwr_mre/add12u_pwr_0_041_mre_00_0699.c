...
uint64_t add12u_pwr_0_041_mre_00_0699(uint64_t a, uint64_t b) {
  int wa[12];
  int wb[12];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_38 = sig_36 & wa[2];
  int sig_39 = sig_36 ^ wa[2];
...
// internal reference: cgp-add-bdd.12.bdd_sift_bw_12_core_0_wce_00005_run_00004
