...
uint64_t add12u_pwr_0_031_wce_00_2075(uint64_t a, uint64_t b) {
  int wa[12];
  int wb[12];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_48 = sig_46 & wb[4];
  int sig_49 = sig_46 ^ wb[4];
...
// internal reference: cgp-add-bdd.12.bdd_sift_bw_12_core_2_wce_00017_run_00002
