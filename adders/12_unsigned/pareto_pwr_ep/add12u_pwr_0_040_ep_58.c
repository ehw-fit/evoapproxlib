...
uint64_t add12u_pwr_0_040_ep_58(uint64_t a, uint64_t b) {
  int wa[12];
  int wb[12];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_53 = wa[6] ^ wb[6];
  int sig_54 = wb[0] ^ wa[0];
  int sig_55 = sig_52;
  ...
  y |=  (sig_53 & 0x01) << 6; // default output
...
// internal reference: cgp-add-bdd.12.bdd_sift_bw_12_core_0_ep_0_60_run_00000
