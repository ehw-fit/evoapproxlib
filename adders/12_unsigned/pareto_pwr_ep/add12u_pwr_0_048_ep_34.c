...
uint64_t add12u_pwr_0_048_ep_34(uint64_t a, uint64_t b) {
  int wa[12];
  int wb[12];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_38 = sig_36 & wb[2];
  int sig_39 = sig_36 ^ wb[2];
  ...
  y |=  (sig_28 & 0x01) << 0; // default output
...
// internal reference: cgp-add-bdd.12.bdd_sift_bw_12_core_0_ep_0_40_run_00001
