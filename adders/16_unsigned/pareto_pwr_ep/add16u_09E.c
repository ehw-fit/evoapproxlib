...
uint64_t add16u_09E(uint64_t a, uint64_t b) {
  int wa[16];
  int wb[16];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  int sig_50 = wa[1] ^ wb[1];
  int sig_51 = wb[4] & sig_48;
  int sig_52 = sig_49 ^ sig_48;
  int sig_53 = wa[4] | sig_51;
  ...
  int sig_76 = sig_74 & wa[8];
  int sig_77 = sig_74 ^ wa[8];
  ...
  y |=  (sig_50 & 0x01) << 1; // default output
...
// internal reference: cgp-add-bdd.16.bdd_sift_bw_16_core_0_ep_0_70_run_00000
