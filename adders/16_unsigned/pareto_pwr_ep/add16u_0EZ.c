...
uint64_t add16u_0EZ(uint64_t a, uint64_t b) {
  int wa[16];
  int wb[16];
  uint64_t y = 0;
  wa[0] = (a >> 0) & 0x01;
  ...
  y |=  (sig_78 & 0x01) << 0; // default output
...
// internal reference: cgp-add-bdd.16.bdd_sift_bw_16_core_0_ep_0_50_run_00004
